        ...
        nixosConfigurations.netboot-installer = nixpkgs.lib.nixosSystem {
	      ...
	      # Install python
              ...
              users.users.ansible = {
                ...
                hashedPassword = null;
                openssh.authorizedKeys.keys = [ "ecdsa-sha2-nistp384 AAAAE2VjZHNhLXNoYTItbmlzdHAzODQAAAAIbmlzdHAzODQAAABhBHUL486IP/L9Atr6vbEQbQ2bW/kJ4qjUHgzDorLyIS2NPjDo/IyOacPqFKwywSiKv8xDeAugzoCV1z843l6S/O1GQKfYEQ4FRr5IBLqRCvLbCt6jI1lFYnpqYJCO0K7nFA==" ];
              };
